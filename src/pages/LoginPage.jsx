...
const LoginPage = () => {
    ...
    // accessing setUser function from auth zustand -> authStore
    ...
    //    distpatch(login(data)) // user ko login information pathako ho authSlice ko user mah
         setUser(data) //zustand ko user state ma login data set garne
         navigate('/')

      // yo data lai server ma send garnu perxa api ko help bata 
